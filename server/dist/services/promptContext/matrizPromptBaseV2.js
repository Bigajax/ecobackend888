...
const matrizPromptBaseV2 = {
    ...
    condicoesEspeciais: {
        ...
        "METODO_VIVA_ENXUTO.txt": {
            descricao: "Ativar quando emoção clara (≥7) e abertura ≥2; máx. 3 movimentos; evitar em saudação/factual/pedido prático/cansaço/desabafo.",
            regra: "intensidade>=7 && nivel>=2 && !pedido_pratico && !saudacao && !factual && !cansaco && !desabafo",
        },
        "BLOCO_TECNICO_MEMORIA.txt": {
        ...
        "eco_heuristica_causas_superam_estatisticas.txt": {
            descricao: "Narrativas causais sedutoras superando evidências estatísticas",
            regra: "causas_superam_estatisticas && nivel>=2 && !pedido_pratico",
        },
        "eco_heuristica_certeza_emocional.txt": {
            descricao: "Certeza emocional/convicção afetiva confundida com evidência",
        ...
        "eco_observador_presente.txt": {
            descricao: "Postura do observador presente; separar estímulo de reação; reduzir ruminação",
            regra: "ruminacao && nivel>=2",
        },
        "eco_presenca_racional.txt": {
            descricao: "Trazer razão serena quando há confusão emocional moderada",
            regra: "confusao_emocional && intensidade>=3 && intensidade<=7 && nivel>=2",
        },
        "eco_corpo_emocao.txt": {
            descricao: "Ponte corpo–emoção: percepção somática para destravar identificação mental",
            regra: "(mencao_corporal || excesso_racionalizacao) && intensidade>=5 && nivel>=2",
        },
        "eco_fim_do_sofrimento.txt": {
            descricao: "Redução do sofrimento por avaliação/aversão; aceitar o que é (estoico)",
            regra: "sofrimento_avaliativo && intensidade>=6 && nivel>=2",
        },
        "eco_identificacao_mente.txt": {
            descricao: "Desidentificação de pensamentos (‘não sou meus pensamentos’)",
        ...
        "LINGUAGEM_NATURAL.txt": {
            descricao: "Guia de linguagem natural da Eco: substituições sem clichê, aberturas contextuais/descritas e validações diretas.",
            regra: "nivel>=1",
        },
    },
    /* ============== prioridade (budget) ============== */
...
exports.matrizPromptBaseV2 = matrizPromptBaseV2;
exports.default = matrizPromptBaseV2;
//# sourceMappingURL=matrizPromptBaseV2.js.map