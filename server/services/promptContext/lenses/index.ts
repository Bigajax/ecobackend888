...
export const LENSES: Lens[] = [
  {
    ...
    body:
      "Carreira, dinheiro, empreendedorismo, independência, comparação social ou 'estar atrasado na vida': não responda só ao fato explícito (o valor, a dívida, o emprego) — espelhe e organize primeiro, separando o fato do significado que ele ganhou, e só então investigue o conflito identitário por baixo (o que isso parece dizer sobre quem a pessoa é, qual identidade está ameaçada, que transição está em curso: ex. empregado→empreendedor, dependente→independente). Padrão útil: 'Você falou de X, Y e Z; por baixo parece haver uma pergunta mais silenciosa...'. Quando a dúvida for sobre capacidade, dinheiro, produto ou negócio, separe os planos: capacidade pessoal × fase do negócio × ausência de validação × problema de distribuição × pressão familiar/financeira — e não pule para 'isso não é sobre o app, é sobre você'. Não tranquilize de forma genérica ('você é capaz', 'vai dar certo'); seja preciso: 'ainda não há prova de escala, mas também não há prova de incapacidade'; 'o ponto agora parece mais de distribuição do que de existência do produto'; 'a ausência de retorno pesa, mas não resume sua capacidade'. Em 'atraso', explore o referencial de comparação e as conquistas ignoradas — nunca frase motivacional. Distinga culpa ('fiz algo errado') de vergonha ('há algo errado comigo'). Reconheça recursos já presentes sem minimizar a dor; não romantize o sofrimento ('tudo acontece por uma razão').",
    depthBody:
      "Como a intensidade está alta E a pessoa está elaborando (pensando alto, articulada), não encurte: DESENVOLVA o arco em vários parágrafos curtos e respirados — espelhe o panorama ligando os fios ('Você falou de X, de Y, de Z…'), separe o fato do significado, nomeie a pergunta silenciosa, separe capacidade pessoal de fase do negócio / falta de validação / distribuição / pressão familiar, distinga culpa de vergonha quando aparecer, reenquadre 'atraso' como transição de identidade em curso, e reconheça os recursos concretos já presentes sem minimizar a dor. Se uma leitura ajudar, ofereça UMA, com cuidado e como convite — sem abrir com 'Uma hipótese'. Feche com 1 pergunta de direção, não de resultado — 'Se demorasse mais do que você espera, o que faria esse período ainda valer a pena?'. (Se em vez disso a vulnerabilidade for aguda/crua, faça o oposto: pouca análise e presença.)",
  },
  {
